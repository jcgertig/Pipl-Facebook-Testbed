...
export const getMoreFriends = (path) => (dispatch, getState) => {
...
export const findBestMatch = (data) => (dispatch, getState) => {
...
export const getPiplForFriend = (firstName, lastName, index) => (dispatch) => {
  Api.getPiplForFriend({ firstName, lastName })
