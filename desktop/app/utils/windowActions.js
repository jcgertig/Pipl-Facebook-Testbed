...
import {
  TRIGGER_WINDOW_ACTION, REGISTER_MAIN, REGISTER, FILE_CHANGED, TRIGGER_SAVE,
...
export function triggerLogin() {
  ...
  ipcRenderer.send(TRIGGER_LOGIN, 'ping');
}
...
export function addGotTokenHandler(renderer, cb) {
  renderer.on(GOT_TOKEN, cb);
}
